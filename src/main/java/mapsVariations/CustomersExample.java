...
public class CustomersExample {
    ...
    public static List<Customer> customerListWithStream() {
        return Arrays.stream(people)
                .collect(Collectors.toList());
    }

    public static List<Customer> customerListWithArrays() {
    ...
    //Napisz metodê, ktora zwróci mapê osób <id,osoba>

    public static Map<Integer, String> idPerson() {
        Map<Integer, String> resultMap = new HashMap<>();
        for (Customer person : people) {
            resultMap.put(person.getId(), person.getFirstName() + " " + person.getSurname());
        }
        return resultMap;
    }
    ...
    public static Map<BigDecimal, Integer> statistics() {
    ...
    //NApisz metodê, która zwróci mapê map <imiê,<zarobki,liczba_osób_z_takimi_zarobkami>>
